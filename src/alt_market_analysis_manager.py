"""Altcoin-specific analysis persistence helper."""
...
class AltMarketAnalysisManager(MarketAnalysisManager):
    """Wrapper so non-BTC live runs write to their own analysis file."""

    DEFAULT_FILE = "data/alt_market_analysis.json"
